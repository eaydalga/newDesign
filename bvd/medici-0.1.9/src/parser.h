...
typedef void (*edi_structure_handler_t) (void *, edi_event_t,
					 edi_parameters_t *);
typedef void (*edi_segment_handler_t) (void *, edi_parameters_t *,
				       edi_segment_t *, edi_directory_t *);
typedef edi_directory_t *(*edi_directory_handler_t) (void *,
						     edi_parameters_t *);
...
struct edi_parser_s
{
  ...
  edi_structure_handler_t start_handler;
  edi_structure_handler_t end_handler;
...
void edi_parser_handle_segment (edi_parser_t *, edi_parameters_t *,
				edi_directory_t *);
edi_directory_t *edi_parser_handle_directory (edi_parser_t *,
					      edi_parameters_t *);
void edi_parser_handle_start (edi_parser_t *, edi_event_t,
			      edi_parameters_t *);
...
void edi_parser_clear_buffer (edi_parser_t *);
void edi_parser_add_to_buffer (edi_parser_t *, char);
void edi_parser_end_tag (edi_parser_t *);
void edi_parser_end_element (edi_parser_t *);
void edi_parser_end_subelement (edi_parser_t *);
void edi_parser_new_segment (edi_parser_t *);
int edi_parser_get_buffer_size (edi_parser_t *);
char *edi_parser_get_buffer_data (edi_parser_t *);
...
edi_structure_handler_t edi_parser_set_start_handler (edi_parser_t *,
						      edi_structure_handler_t);
edi_structure_handler_t edi_parser_set_end_handler (edi_parser_t *,
						    edi_structure_handler_t);
edi_error_handler_t edi_parser_set_error_handler (edi_parser_t *,
						  edi_error_handler_t);
edi_error_handler_t edi_parser_set_warning_handler (edi_parser_t *,
						    edi_error_handler_t);
edi_token_handler_t edi_parser_set_token_handler (edi_parser_t *,
						  edi_token_handler_t);
edi_directory_handler_t edi_parser_set_directory_handler (edi_parser_t *,
							  edi_directory_handler_t);
edi_segment_handler_t edi_parser_set_segment_handler (edi_parser_t *,
						      edi_segment_handler_t);
void *edi_parser_set_user_data (edi_parser_t *, void *);
void edi_parser_token_handler (void *, edi_token_t *);
