...
#define this ((edi_x12_t *) THIS)


#define SERVICE THIS->service
...
edi_x12_segment (edi_parser_t * THIS)
{
  ...
  edi_x12_set_parameters (THIS, segment, &parameters);
  ...
  switch (segment_code)
    ...
    case ISA:
      if ((version = edi_get_element_by_name (SERVICE, segment, "I11", NULL)))
	this->version = atoi (version) * 10;
      edi_parser_handle_start (THIS, EDI_INTERCHANGE, &parameters);
      edi_parser_handle_segment (THIS, &parameters, SERVICE);
      this->transactions = 0;
      this->groups = 0;
      break;
    ...
    case GS:
      if ((version = edi_get_element_by_name (SERVICE, segment, "480", NULL)))
    ...
    case ST:
      ...
      transaction = edi_get_element_by_name (SERVICE, segment, "143", NULL);
      MESSAGE = edi_parser_handle_directory (THIS, &parameters);
      edi_directory_head (MESSAGE, segment, &parameters,
    ...
    case SE:
      if (atoi (edi_segment_get_element (segment, 0, 0)) != ++this->segments)
	return edi_parser_raise_error (THIS, EDI_ETTC);
      edi_directory_tail (MESSAGE, segment, &parameters, THIS, SERVICE);
      edi_parser_handle_end (THIS, EDI_TRANSACTION, &parameters);
      break;
	...
	return edi_parser_raise_error (THIS, EDI_EGTC);
      edi_parser_handle_segment (THIS, &parameters, SERVICE);
      edi_parser_handle_end (THIS, EDI_GROUP, &parameters);
      break;


    case IEA:
      if (atoi (edi_segment_get_element (segment, 0, 0)) != this->groups)
	return edi_parser_raise_error (THIS, EDI_EITC);
      edi_parser_handle_segment (THIS, &parameters, SERVICE);
      edi_parser_handle_end (THIS, EDI_INTERCHANGE, &parameters);
      break;


    default:
      edi_directory_body (MESSAGE, segment, &parameters, THIS, NULL);
      this->segments++;
    }
...
edi_error_t
edi_x12_init (edi_parser_t * THIS)
{
  edi_advice_t *advice = &(THIS->tokeniser.advice);

  memset (this, 0, sizeof (edi_x12_t));	/* mitigate bugs */
  SERVICE = X12_V4011_SYSTEM ();
  MESSAGE = NULL;

  THIS->syntax_fini = fini;

  /* initialise lexical state automata */
  edi_advice_set_ss (advice, 1, ASCII_COLON);
  edi_advice_set_es (advice, 1, ASCII_ASTERISK);
  edi_advice_set_st (advice, 1, ASCII_LF);

  THIS->sgmnt_handler = edi_x12_segment;
...
#define EDI_ISO2382DT EDI_ISO2382N
#define EDI_ISO2382TM EDI_ISO2382N
#define EDI_ISO2382ID EDI_ISO2382X

static edi_francesco_element_info_t elementinfo[] = {
  {"I06", EDI_ISO2382X, 15, 15, "Interchange Sender ID", NULL},
  {"I05", EDI_ISO2382ID, 2, 2, "Interchange ID Qualifier", NULL},
  {"I16", EDI_ISO2382N, 1, 5, "Number of Included Functional Groups", NULL},
  {"I15", EDI_ISO2382ID, 1, 1, "Component Element Separator", NULL},
  {"I09", EDI_ISO2382TM, 4, 4, "Interchange Time", NULL},
  {"I14", EDI_ISO2382ID, 1, 1, "Usage Indicator", NULL},
  {"I13", EDI_ISO2382ID, 1, 1, "Acknowledgment Requested", NULL},
  {"I04", EDI_ISO2382X, 10, 10, "Security Information", NULL},
  {"I12", EDI_ISO2382N, 9, 9, "Interchange Control Number", NULL},
  {"I11", EDI_ISO2382ID, 5, 5, "Interchange Control Version Number", NULL},
  {"I03", EDI_ISO2382ID, 2, 2, "Security Information Qualifier", NULL},
  {"I10", EDI_ISO2382ID, 1, 1, "Interchange Control Standards Identifier",
   NULL},
  {"I02", EDI_ISO2382X, 10, 10, "Authorization Information", NULL},
  {"I08", EDI_ISO2382DT, 6, 6, "Interchange Date", NULL},
  {"I01", EDI_ISO2382ID, 2, 2, "Authorization Information Qualifier", NULL},
  ...
  {"143", EDI_ISO2382ID, 3, 3, "Transaction Set Identifier Code", NULL},
  {"329", EDI_ISO2382X, 4, 9, "Transaction Set Control Number", NULL},
  {"337", EDI_ISO2382TM, 4, 8, "Time"},
  {"373", EDI_ISO2382DT, 8, 8, "Date", NULL},
  {"455", EDI_ISO2382ID, 1, 2, "Responsible Agency Code", NULL},
  {"479", EDI_ISO2382ID, 2, 2, "Functional Identifier Code", NULL},
  {"480", EDI_ISO2382X, 1, 12, "Version / Release / Industry Identifier Code",
   NULL},
  {NULL}
};
...
static edi_francesco_codelst_info_t codelistinfo[] = {
  ...
  {"I11", "00201",
   ...
   NULL},
  {"I11", "00204",
   "Draft Standard for Trial Use Approved by ASC X12 Through May 1989", NULL},
  ...
  {"I01", "06", "United States Federal Government Communication Identifier",
   NULL},
  ...
  {"I05", "21", "Integrated Postsecondary Education Data System, or (IPEDS)",
   NULL},
  ...
  {"I05", "25",
   ...
   NULL},
  {"I05", "26", "Statistics of Canada List of Postsecondary Institutions",
   NULL},
  {"I05", "27",
  ...
  {"I05", "33",
   ...
   NULL},
  {"I05", "34",
   "Medicaid Provider and Supplier Identification Number as assigned by individual State Medicaid Agencies in conjunction with Health Care Financing Administration (HCFA)",
   NULL},
  {"I05", "35",
  ...
  {"I05", "36",
   ...
   NULL},
  {"I05", "37", "Society of Property Information Compilers and Analysts",
   NULL},
  {"I05", "AM",
   "Association Mexicana del Codigo de Producto (AMECOP) Communication ID",
   NULL},
  {"I05", "NR", "National Retail Merchants Association (NRMA) - Assigned",
   NULL},
  ...
  {"143", "147",
   "Response to Request for Student Educational Record (Transcript)", NULL},
  ...
  {"143", "195",
   "Federal Communications Commission (FCC) License Application", NULL},
  ...
  {"143", "285",
   "Commercial Vehicle Safety and Credentials Information Exchange", NULL},
  ...
  {"143", "865",
   "Purchase Order Change Acknowledgment/Request - Seller Initiated", NULL},
  ...
  {"479", "AK",
   "Student Educational Record (Transcript) Acknowledgment (131)", NULL},
  {"479", "AL",
  ...
  {"479", "CA",
   ...
   NULL},
  {"479", "CB",
   "Unemployment Insurance Tax Claim or Charge Information (153)", NULL},
  ...
  {"479", "IF", "Individual Insurance Policy and Client Information (111)",
   NULL},
  ...
  {"479", "LA",
   "Federal Communications Commission (FCC) License Application (195)", NULL},
  ...
  {"479", "ME",
   "Mortgage Origination (198, 200, 201, 261, 262, 263, 833, 872)", NULL},
  {"479", "MF", "Market Development Funds Settlement (884)", NULL},
  {"479", "MG",
   "Mortgage Servicing Transaction Sets (203, 206, 260, 264, 266)", NULL},
  ...
  {"480", "002001", "Draft Standards Approved by ASC X12 in November 1987",
   NULL},
  {"480", "002002",
   "Draft Standards Approved by ASC X12 through February 1988", NULL},
  {"480", "002003", "Draft Standards Approved by ASC X12 through August 1988",
   NULL},
  {"480", "002031",
   "Draft Standards Approved by ASC X12 Through February 1989", NULL},
  {"480", "002040", "Draft Standards Approved by ASC X12 Through May 1989",
   NULL},
  {"480", "002041",
   "Draft Standards Approved by ASC X12 Through October 1989", NULL},
  {"480", "002042",
   "Draft Standards Approved By ASC X12 Through February 1990", NULL},
  {"480", "003000", "ASC X12 Standards Approved by ANSI in 1992", NULL},
  {"480", "003010", "Draft Standards Approved By ASC X12 Through June 1990",
   NULL},
  {"480", "003011",
  ...
  {"480", "003040",
   ...
   NULL},
  {"480", "003041",
   "Draft Standards Approved for Publication by ASC by ASC X12 Procedures Review Board through February 1994",
   NULL},
  {"480", "003042",
  ...
  {"480", "004010",
   ...
   NULL},
  {"480", "004011",
   "Draft Standards Approved for Publication by ASC X12 Procedures Review Board through February 1998",
   NULL},
  {"480", "004012",
   "Draft Standards Approved for Publication by ASC X12 Procedures Review Board through June 1998",
   NULL},
  {"480", "004020",
