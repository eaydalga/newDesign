...
struct edi_directory_s
{
  ...
  /** \brief Called for each segment in a transaction */
    edi_error_t (*parse) (edi_directory_t *, edi_segment_t *,
  ...
  int (*element_indx) (edi_directory_t *, char *, char *, char *, int *,
		       int *);
...
/* drctry.c */
edi_error_t edi_directory_head (edi_directory_t *, edi_segment_t *,
				edi_parameters_t *, edi_parser_t *,
				edi_directory_t *, char *);
edi_error_t edi_directory_body (edi_directory_t *, edi_segment_t *,
				edi_parameters_t *, edi_parser_t *,
				edi_directory_t *);
edi_error_t edi_directory_tail (edi_directory_t *, edi_segment_t *,
				edi_parameters_t *, edi_parser_t *,
				edi_directory_t *);
...
char **edi_directory_segment_list (edi_directory_t *, char *);
...
char **edi_directory_composite_list (edi_directory_t *, char *);
...
edi_directory_t *edi_directory_create (void);
...
edi_item_t edi_directory_composite_item (edi_directory_t *, char *,
					 unsigned int);
edi_item_t edi_directory_segment_item (edi_directory_t *, char *,
				       unsigned int);
edi_item_t edi_directory_element_repr (edi_directory_t *, char *);

char *edi_get_element_by_name (edi_directory_t *, edi_segment_t *, char *,
			       char *);
